    ...
    <head>
        ...
        <script>
            ...
            function redirectToLogin() {
                ...
                var redirectUri = 'https://andydim.click';
                var loginUrl = "https://andydim.auth.${region}.amazoncognito.com/login?client_id=${clientId}&response_type=code&scope=email+openid+phone&redirect_uri=https%3A%2F%2Fandydim.click";
            ...
            function getCredentials(authCode) {
                var clientId = '${clientId}';
                var redirectUri = 'https://andydim.click';
                var authEndpoint = 'https://andydim.auth.${region}.amazoncognito.com/oauth2/token';
